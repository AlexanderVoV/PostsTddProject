...
public class PostControllerTest {
    ...
    @Test
    void shouldFindPostPostWhenGivenValidID() throws Exception {
    ...
    @Test
    void shouldCreateBewPostWhenPostIsValid() throws Exception {
        var post = new Post(3, 1, "New post", "BODY POST", null);
    ...
    void shouldUpdatePostWhenGivenValidPost() throws Exception {
        var updated = new Post(1, 1, "Updated Title", "Updated Body", null);
